...
{
    /// <summary>
    /// Transfer transaction fee estimator for "transfer amount" transactions model.
    /// </summary>
    public interface ITransferAmountTransactionsEstimator
    {
        /// <summary>
        ...
        /// Should be thrown if a transaction can’t be estimated with the given parameters and it will never be possible to
